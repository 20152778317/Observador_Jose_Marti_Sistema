...
<!--Inicio para citacion -->

<h1> <small>Gestion Citaciónes</small></h1>
<form class="form-inline">
  <div class="form-group">
          </div>
  <div class="form-group">
    <label for="inputPassword2" class="sr-only"></label>
    Identificacion Estudiante: <input type="text" class="form-control" id="txtBuscarIdCitaciones" placeholder=" ">
  </div>
